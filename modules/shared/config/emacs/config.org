...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Michal Kopczynski"
    user-mail-address "26494112+michal-kopczynski@users.noreply.github.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mk058946/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mk058946/bin" "/profile/bin" "/Users/mk058946/.npm-packages/bin" "/Users/mk058946/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
